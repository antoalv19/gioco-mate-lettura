...
Aggiungi un oggetto a `reading.json`. I tipi ammessi sono `syllable`, `word-to-emoji`, `emoji-to-word` e `sentence-to-emoji`. Gli esercizi che chiedono di riconoscere una lettera identica non vengono mostrati. Usa il minuscolo per gli esercizi medi e frasi di 2–5 parole per gli esercizi difficili.
