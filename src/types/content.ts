...
export type Mode = 'somma' | 'sottrazione' | 'lettura' | 'scrittura' | 'mix' | 'pratica';
...
export interface ReadingExercise { id: string; type: 'letter' | 'syllable' | 'word-to-emoji' | 'emoji-to-word' | 'sentence-to-emoji'; difficulty: Difficulty; prompt: string; display: string; correctAnswer: string; answers: string[] }
